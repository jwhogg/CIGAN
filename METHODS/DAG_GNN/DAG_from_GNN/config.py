...
class CONFIG:
    ...
    #used to allow terminal to change file to use, with a helper py file
    with open('file_pointer.txt') as f:
        file_pointer = f.readline().strip('\n')
    data_filename = file_pointer
    # data_filename = "iq_brain_size.continuous.csv"
